...
const PatientRegistrationPage = () => {
  ...
  const patientDetailsFields = [
    ...
    { name: "villageName", label: "Name of the Village", type: "text" },
    {
      ...
      label: "Type of PwTB",
      type: "select",
      options: ["Identified by Project", "Received from NTEP"],
    },
    {
      name: "clinicalMicrobiological",
      label: "Clinical/Microbiological",
      type: "select",
      options: ["Clinical", "Microbiological"],
    },
                          ...
                          render={({ field }) =>
                            type === "select" ? (
                              <TextField
                                ...
                                error={
                                  !!errors[
                                    name as keyof PatientRegistrationData
                                  ]
                                }
                                helperText={
                                  errors[name as keyof PatientRegistrationData]
                                    ?.message
                                }
